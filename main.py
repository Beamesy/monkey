...
charter = sprites.create(img("""
    ...
    """),
    SpriteKind.player)
controller.move_sprite(charter)
scene.set_background_image(img("""
    9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999
        ...
        bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb
"""))
charter.set_stay_in_screen(True)
info.set_life(1)
pause(2000)
for index in range(99999999):
    ...
    car = sprites.create(img("""
        ...
        """),
        SpriteKind.enemy)
    car.set_position(-4, 29)
    car.set_velocity(50, 0)
    car = sprites.create(img("""
            . . . . . . . . . . . . . . . . 
                    . . . . . . . . . . . . . . . . 
                    . . . . . . . . . . . . . . . . 
    ...
    car2 = sprites.create(img("""
        ...
        """),
        SpriteKind.enemy)
    car.set_position(-6, 52)
    car.set_velocity(50, 0)
    car.set_position(0, 29)
    car2.set_position(-2, 105)
    ...
    car3 = sprites.create(img("""
        ...
        """),
        SpriteKind.enemy)
    car3.set_position(-6, 81)
    car3.set_velocity(50, 0)
    pause(min(1000, 35000))
    car4 = sprites.create(img("""
            . . . . . . . . . . . . . . . . 
                    . . . . 2 2 2 2 2 2 2 2 . . . . 
        ...
        """),
        SpriteKind.enemy)
    car4.set_velocity(50, 0)
    car4.set_position(-2, 57)
    pause(min(1000, 35000))